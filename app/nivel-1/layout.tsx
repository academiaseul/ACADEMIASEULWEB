...
export const metadata: Metadata = {
  ...
  description:
    'Matrícula abierta: Básico 1 (A1.1), Básico 2 (A1.2), Conversacional 1 (A2.1), TOPIK II (B1+) y Coreano para Niños (8–15). 8 semanas en vivo por Zoom, 60 min por clase, certificado incluido. US$150 el curso completo o 2 cuotas de US$75. Inicio la semana del 12 de octubre de 2026.',
