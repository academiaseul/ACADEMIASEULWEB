# Boletín de cursos · Posts de Instagram estilo catálogo universitario
### Cohorte octubre 2026 · 7 láminas 1080×1350 · captions listos + calendario de publicación

**Imágenes:** `Posts_Boletin_Cursos_Octubre_2026/` (PNG 1080×1350 listos para subir). Se regeneran con `make_catalog_posts.js` (en esta carpeta; copia de trabajo en el scratchpad) (HTML → PNG con Chrome headless); los datos vienen de `lib/nivel1.ts`.

**La idea:** presentar la cohorte como un *course bulletin* de MIT/Stanford — código de curso (KOR 101…), nivel CEFR, secciones, prerrequisito, cupo, arancel, descripción, resultados de aprendizaje y programa de 8 sesiones. Serio y prolijo, pero con el tigre y el azul de la marca. Sin rojo.
...
## Calendario de publicación (programar en Meta Business Suite · hora Chile)

Encaja con la campaña del 15 sept → 5 oct (`Campana_Lanzamiento_Octubre_2026.md`) sin pisar los reels ni el reto. Regla: **un curso por post**, siempre a las 12:30 o 19:30 (los dos picos de LATAM + España despierta).

| Fecha | Hora | Post | Formato | Nota |
|---|---|---|---|---|
| **Mié 17 sept** | 19:30 | **Carrusel completo** 0→6 (7 láminas) | Carrusel | Post ancla: fíjalo arriba del perfil. Guardable = alcance. |
| **Vie 19 sept** | 12:30 | KOR 101 · Básico 1 | Imagen + historia | Es el curso con más demanda; sale primero y coincide con la historia "¿a qué hora es en tu país?". |
| **Dom 21 sept** | 19:30 | KOR 050 · Niños | Imagen | Domingo = papás mirando el celular. |
...
## Captions (copiar y pegar)

### 0 · Carrusel completo · "Boletín de cursos"
```
📘 BOLETÍN DE CURSOS · Cohorte octubre 2026
...
### 1 · KOR 101 · Básico 1
```
KOR 101 · Básico 1 (A1.1) · "Primeras Palabras" 🌱
...
### 2 · KOR 102 · Básico 2
```
KOR 102 · Básico 2 (A1.2) · "Pasado, presente y futuro" 🚀

¿Hiciste el Nivel 1 de julio? Este es tu siguiente paso (mismo curso, nuevo nombre: Básico 1 → Básico 2).

Del presente al pasado y al futuro: cuentas lo que hiciste, planeas lo que harás y sumas las partículas que hacen sonar natural tu coreano. Meta de la sesión 8: conversar 5 minutos seguidos.

📅 Miércoles 21:00 (hora Chile)
👨‍🏫 Jay · 김재희
⏱ 8 semanas · 60 min · Zoom · 15 cupos · certificado
💵 US$150 · o 2 cuotas de US$75
...
### 3 · KOR 201 · Conversacional 1
```
KOR 201 · Conversacional 1 (A2.1) · "Corea que amas" 💬

Puro hablar. Cada semana un tema: K-pop, Jeju, comida, hanbok, PC방 y e-sports — con Abby (홍미영), profesora coreana nativa que dicta desde Corea. La mitad de las sesiones son laboratorio de conversación en grupo pequeño.

📅 Martes 21:00 Chile (= miércoles 09:00 en Corea ☀️)
👩‍🏫 Abby · 홍미영
⏱ 8 semanas · 60 min · Zoom · 15 cupos · certificado A2.1
💵 US$150 · o 2 cuotas de US$75
...
### 4 · KOR 301 · TOPIK II
```
KOR 301 · TOPIK II (B1+) · "Estrategia de examen" 🎯

Grupo de máximo 8 personas enfocado 100 % en el examen oficial: estrategia por sección, corrección personalizada de escritura (쓰기 51–54) y simulacros cronometrados. Ideal si apuntas al TOPIK de abril.

📅 Jueves 21:00 (hora Chile)
👨‍🏫 Jay · 김재희
⏱ 8 semanas · 60 min · Zoom · solo 8 cupos · certificado
💵 US$150 · o 2 cuotas de US$75
...
1️⃣ Elige tu curso tocando tu caso en academiaseul.com/nivel-1
2️⃣ Reserva tu cupo (1 minuto, ves tu horario en la hora de tu país)
3️⃣ Paga como prefieras: Mercado Pago, PayPal o transferencia

Arancel: US$150 el curso completo · o 2 cuotas de US$75. Mismo precio en todos los niveles.

Dudas → WhatsApp +56 9 4211 5562
...
#aprendecoreano #academiaseul #ultimoscupos
```
